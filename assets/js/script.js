(function ($) {
   ...
   ========================================================================== */
	...
	function TabsPrices() {
		let tabhedareitems = document.querySelector(".special-features-tab");
		if (tabhedareitems) {
			let lis = tabhedareitems.querySelectorAll("li");
			let bodyItems = document.querySelectorAll(".special-features-tab-body .tab-item");
			for (var i = 0; i < lis.length; i++) {
				let currEl = lis[i];
				let currTab = bodyItems[i];
				currEl.addEventListener("click", () => {
					document.querySelector(".special-features-tab-body .active")?.classList?.remove("active");
					document.querySelector(".special-features-tab .active")?.classList?.remove("active");

					console.clear();
					console.log(lis, currEl);
